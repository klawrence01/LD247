// /src/app/dashboard/merchant/Merchant-Backup/business/page.tsx
import {
  createSupabaseServerClient,
  createSupabaseServer,
} from "@/utils/supabase/server";

export default async function MerchantBusinessBackupPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h1 className="text-2xl font-bold">Your Business (Backup)</h1>
      {businesses.length === 0 ? (
