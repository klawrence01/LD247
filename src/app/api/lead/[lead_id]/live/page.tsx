...
import ChoosePlanBlock from "../choose-plan-block";
    ...
    <div className="max-w-md mx-auto px-4 py-16 space-y-8 text-center">
      ...
      <section className="rounded-2xl border border-gray-200 bg-white shadow-sm p-4 text-left space-y-4">
        ...
        <ol className="text-sm text-gray-700 space-y-3 list-decimal list-inside">
          <li>
            You’re visible in{" "}
            <span className="font-medium text-gray-900">{lead.region_tag}</span>.
          </li>
          <li>
            We’ll help you post attention-grabbing deals (like “Buy 1 Get 1” or
            “Free Add-On After 5 pm”).
          </li>
          <li>
        ...
        <div className="text-[11px] text-gray-500 leading-snug">
          Many of our local merchants see 30–90 % more activity in this period —
          sometimes turning their slowest days into their busiest — without
          spending thousands on ads.
        </div>
      </section>
      ...
      {/* PLAN CHOICES */}
      <ChoosePlanBlock leadId={lead.id} regionTag={lead.region_tag} />
